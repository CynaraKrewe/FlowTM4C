...
2. Open a terminal and go to the root folder of the project, it contains `conanfile.py`.
3. Install the conan packages: `$ conan install`
4. Open TI Code Composer Studio [(get it from Texas Instruments)](http://processors.wiki.ti.com/index.php/Download_CCS).
5. Right click in the project explorer window and do `Import > CCS projects`. In the dialog, point the search-directory to the root folder and select the discovered `FlowTM4C` project.
6. Build and do something fancy!