...
class FlowTM4C(ConanFile):
	...
	requires = "FlowCore/1.2@spiessensm/stable", "TM4C-usblib/2.1.4.178@spiessensm/stable"
	
	def source(self):
		download("https://github.com/CynaraKrewe/FlowTM4C/archive/v1.1.zip", "FlowTM4C-1.1.zip")
		unzip("FlowTM4C-1.1.zip")
		shutil.move("FlowTM4C-1.1", "FlowTM4C")
		os.unlink("FlowTM4C-1.1.zip")
