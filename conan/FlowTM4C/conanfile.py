...
class FlowTM4C(ConanFile):
	...
	def source(self):
		download("https://github.com/CynaraKrewe/FlowTM4C/archive/v1.3.zip", "FlowTM4C-1.3.zip")
		unzip("FlowTM4C-1.3.zip")
		shutil.move("FlowTM4C-1.3", "FlowTM4C")
		os.unlink("FlowTM4C-1.3.zip")
